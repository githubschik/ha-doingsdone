...
function countCategoryProjects($arr,$check4prj)
{
    $count = 0;
    foreach($arr as $arrProject)
    {
        if($arrProject["category"] == $check4prj)
            ++$count;
    }    
    return $count;
}
        ...
        <div class="content">
                ...
                <nav class="main-navigation">
                    <ul class="main-navigation__list">
                        ...
                        <li class="main-navigation__list-item">
                            ...
                            <span class="main-navigation__list-item-count"><?=countCategoryProjects($tasks,$project);?></span>
                        </li>
                        <?php endforeach;?>
                    </ul>
                </nav>
            ...
            <main class="content__main">
                ...
                <table class="tasks">
                    ...
                    <?php if($show_complete_tasks == 0 && $task["isdone"]) continue; ?>
